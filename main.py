...
if __name__ == "__main__":
    ...
    parser.add_argument("--mutate_prob", type=float, default=0.56, required=False)
    parser.add_argument("--elite", type=int, default=16, required=False)
    parser.add_argument("--alpha", type=float, default=0.45, required=False)
    parser.add_argument("--beta", type=float, default=0.02, required=False)
